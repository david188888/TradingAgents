...
| Public research Q&A and portable export | [`research/conversation_models.py`](../../tradingagents/research/conversation_models.py), [`research/conversation_store.py`](../../tradingagents/research/conversation_store.py), [`research/conversation_export.py`](../../tradingagents/research/conversation_export.py) | Local thread persistence, manifest/JSON/Markdown/JSONL consumers |
...
| Web request and response models | [`tradingagents/web/schemas.py`](../../tradingagents/web/schemas.py), [`reader_models.py`](../../tradingagents/web/reader_models.py), [`audit_models.py`](../../tradingagents/web/audit_models.py) | FastAPI routes, projections, API clients |
