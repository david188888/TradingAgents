...
| Research evidence and cross-run artifacts | [`research/case_assembly.py`](../../tradingagents/research/case_assembly.py), [`research/thesis_diff.py`](../../tradingagents/research/thesis_diff.py) | Execution publisher, web Reader projection |
